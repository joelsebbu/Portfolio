...
function Resume() {
  ...
  const handleDownload = () => {
    alert(contact.resumeSection.downloadAlert);
  };

  return (
    <section id="resume" className="resume">
      <div className="resume-content">
        <h2>{contact.resumeSection.title}</h2>
        <p className="resume-description">
          {contact.resumeSection.description}
        </p>
        <div className="resume-actions">
          <button onClick={handleDownload} className="download-btn">
            ...
            {contact.resumeSection.buttons.download}
          </button>
          <button
          ...
          >
            ...
            {contact.resumeSection.buttons.contact}
          </button>
        </div>
